        ...
        <div class="flex flex-wrap gap-x-4 overflow-hidden rounded-lg border sm:gap-y-4 lg:gap-6">
          ...
          <div class="flex flex-1 flex-col justify-between py-4">
            <div>
              ...
              <span class="block text-gray-500">{{ $item->color_id }}</span>
            ...
            <div class="flex flex-wrap gap-x-4 overflow-hidden rounded-lg border sm:gap-y-4 lg:gap-6">
              ...
              <div class="flex flex-1 flex-col justify-between py-4">
                <div>
                  ...
                  <span class="block text-gray-500">カラー:{{ $item->color_id }}</span>
                  <span class="block text-gray-500">プラン:{{ $item->plan_id }}</span>
                </div>
              ...
              <div class="flex w-full justify-between border-t p-4 sm:w-auto sm:border-none sm:pl-0 lg:p-6 lg:pl-0">
                <div class="flex flex-col items-start gap-2">
                  <div class="flex h-12 w-20 overflow-hidden rounded border">
                    <input type="number" name="quantity" value="{{ old('quantity') }}" required class="w-full px-4 py-2 outline-none ring-inset ring-indigo-300 transition duration-100 focus:ring" />
